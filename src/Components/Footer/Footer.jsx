...
//           <div className={`${styles.footerLinksWrapper} row`}>
//             <div className={`${styles.linksWrapper1} col-sm-12 col-md`}>
//               <h3>Shop and Learn</h3>
//               <ul>
//                 <li>
//                   <a href="#">Mac</a>
...
//             <div className={`${styles.linksWrapper2} col-sm-12 col-md`}>
//               <h3>Services</h3>
//               <ul>
//                 <li>
...
//             <div className={`${styles.linksWrapper3} col-sm-12 col-md`}>
//               <h3>Apple Store</h3>
//               <ul>
//                 <li>
...
//             <div className={`${styles.linksWrapper4} col-sm-12 col-md`}>
//               <h3>For Business</h3>
//               <ul>
//                 <li>
...
//             <div className={`${styles.linksWrapper5} col-sm-12 col-md`}>
//               <h3>Apple Values</h3>
//               <ul>
//                 <li>
//                   <a href="#">Find a Store</a>
...
//           <div className={`${styles.copyrightWrapper} row`}>
//             <div className="copyright col-sm-12 order-2 col-md-8 order-md-1 col-lg-4 order-lg-1">
//               Copyright &copy; 2020 Apple Inc. All rights reserved.
//             </div>
//             <div className="footer-links-terms col-sm-12 order-3 col-lg-6 order-lg-2">
